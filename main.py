...
if __name__ == "__main__":
	...
	print("4: Estimate Jaccard similarity")
	...
	if action == 1:
		...
		for file1, file2 in configs:
			...
			main_estimate_jaccard.estimate_jaccard_from_filepaths(file1, file2, 0.01, coppie_famose,
		...
		for coppia_famosa in coppie_famose_sorted:
			print(str(coppia_famosa[0]), "(" + str(coppia_famosa[1]) + ")")
	elif action == 5:
